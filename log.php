...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-br" lang="pt-br">
	<head>
		...
		<title><?php echo $oMenu->getVersao()?> - Log de Alterações</title>
        ...
        <script language="javascript">
			...
			function listaLog()
			{							
				sURL  = "ajax/log.php?origem=lista";				
				enviaDadosAJAX(sURL, 'retornoListaLog','divCarregando',false);				
			}
			
			function retornoListaLog(ret)
			{
    ...
    <div class="geral">
        ...
        <?php $oMenu->createMenu()?>
            <div class="tituloPagina"><img src="images/log.png"/>&nbsp;<b>Log de Alterações</b></div>
            <div id="conteudo" name="conteudo" class="divConteudo"> 
            <img src="images/atualizar.png" onclick="listaLog()" title="Atualizar"/>
